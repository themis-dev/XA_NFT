    ...
    <div class="activity-wrapper">
        ...
        <div class="collection-wrapper">
            ...
            <div class="description-wrapper">
                <div class="desc">为迎接雄安新区成立五周年，雄安区块链实验室、雄安新区未来工业设计研究院联合人民雄安网、北京星原传奇文化传媒有限公司、中信银行科技团队共同在数字文旅领域推出发行数字纪念品，在“雄安数字纪念品平台”幻安，以数字图片、3D 荣誉宝盒等形式亮相。主要包括五大系列：《雄安建设大事记数字图片》、《我与雄安的故事系列数字明信片》、《纪念数字海报》、《纪念数字书法集》、《以先见，见未来》3D荣誉宝盒系列，每个系列限量发行。纪念品均基于雄安区块链技术铸造生成，都具有独一无二的链上序列号，作为在雄安链上对应且唯一的权利证明。彰显雄安未来城市的新形象、新时尚，增强雄安引领未来城市品牌的认知，更好的记录、延续“专属”于建设者的雄安数字记忆。</div>
            </div>
        </div>
        <el-dialog
            title=""
