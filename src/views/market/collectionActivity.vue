    ...
    <div class="activity-wrapper">
        ...
        <div class="collection-wrapper">
            ...
            <div class="description-wrapper">
                <div class="desc">为迎接雄安新区成立五周年，雄安区块链实验室、雄安新区未来工业设计研究院联合人民雄安网、北京星原传奇文化传媒有限公司、中信银行科技团队共同在数字文旅领域推出发行数字纪念品，其将在“雄安数字纪念平台”--幻安，以数字图片、3D 荣誉宝盒的形式向公众亮相。数字图片以新区五年来各行业不同发展阶段的珍藏“大事记”照片、展现雄安各行业建设者新形象的“我与雄安的故事”系列数字明信片、为了庆祝新区五周年联合知名设计公司绘制的雄安五周年纪念海报，用数字图片定格雄安记忆；以及3D荣誉宝盒将以古文明纪念品、“雄安今朝”纪念品、“未来之眼”纪念品的三个系列发行，以先见，见未来。每张图片、每个3D荣誉宝盒均基于雄安区块链技术铸造生成，都具有独一无二的链上序列号，可以作为数字纪念品在雄安链上对应且唯一的权利证明。彰显雄安未来城市的新形象、新时尚，增强雄安引领未来城市品牌的认知，更好的记录、延续“专属”于建设者的雄安数字记忆。</div>
            </div>
        </div>
        <el-dialog
            title=""
        ...
        <div class="dialog-wrapper" ref="screen">
                <div class="dialog-image-wrapper">
                    ...
                    <div class="dialog-content">
                        为迎接雄安新区成立五周年，雄安区块链实验室、雄安新区未来工业设计研究院联合人民雄安网、北京星原传奇文化传媒有限公司、中信银行科技团队共同在数字文旅领域推出发行数字纪念品，在“雄安数字纪念品平台”幻安，以数字图片、3D 荣誉宝盒等形式亮相。
